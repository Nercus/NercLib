...
function NercUtils:GetDefault(...) end
...
function NercUtils:SetDefault(...) end

---Save a variable to the saved variables
---@param ... string | number | boolean | table The last element is the value to save and the rest are keys where the value should be saved
function NercUtils:SetVar(...) end
...
function NercUtils:AddAddonToWhitelist(addonName) end
...
function NercUtils:AddDebugCustomDebugAction(menuTemplate) end

---Get the menu generator function for a given menu template
---@param menuTemplate AnyMenuEntry[]
---@return function
function NercUtils:GetGeneratorFunction(menuTemplate) end
...
function NercUtils:GenerateMenu(parentFrame, menuTemplate, options) end

---Register an options category
---@param category string
---@param order number
function NercUtils:RegisterCategory(category, order) end

---Register an option for a given category
---@param optionType FormType
---@param option OptionObjectVariants
function NercUtils:RegisterOption(optionType, option) end
...
function NercUtils:GenerateUUID(prefix) end
...
function NercUtils:SetSlashTrigger(trigger, triggerIndex) end

---Print the help message for the addon
function NercUtils:PrintHelp() end
...
function NercUtils:AddSlashCommand(command, func, help) end

---Remove a slash command from the list
---@param command string the command to remove
function NercUtils:RemoveSlashCommand(command) end

---Enable the help command for the addon
function NercUtils:EnableHelpCommand() end

---Debounce a function call to prevent it from being called too frequently
---@param func fun()
---@param delay number
---@return function
function NercUtils:DebounceChange(func, delay) end
...
---@param onFinish fun()?
function NercUtils:BatchExecution(funcList, onUpdate, onFinish) end
